...
module.exports = function(pb) {
     ...
     * @param {Function} cb A callback that takes a single parameter: an error if occurred
     */
    BookService.getAll = function(context, cb) {
     ...
     * @param {Function} cb A callback that takes a single parameter: an error if occurred
     */
    BookService.get = function(context, cb) {
    ...
    BaseObjectService.on(TYPE + '.' + BaseObjectService.GET, BookService.get);
    BaseObjectService.on(TYPE + '.' + BaseObjectService.GET_ALL, BookService.getAll);
