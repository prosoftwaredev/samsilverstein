...
module.exports = function PortfolioModule(pb) {
    ...
    /**
     * Portfolio-RTL - RTL version of portfolio site theme for PencilBlue
     *
     * @author Blake Callens <blake@pencilblue.org>
     * @editor AmirSaber Sharifi <saber@amir.ninja>
    ...
    Portfolio.onStartup = function(cb) {
        pb.AdminSubnavService.registerFor('plugin_settings', function(navKey, localization, data) {
            if(data.plugin.uid === 'portfolio-rtl') {
                return [
                    {
                        name: 'home_page_settings',
                        title: 'Home page settings',
                        icon: 'home',
                        href: '/admin/plugins/portfolio-rtl/settings/home_page'
                    }
                ];
            }
            return [];
