...
module.exports = function HomePageSettingsModule(pb) {
    ...
    /**
     * Settings for the display of home page content in the Portfolio(RTL) theme
    ...
    HomePageSettings.prototype.render = function(cb) {
        ...
        var pills = [
        {
            ...
            icon: 'chevron-left',
            href: '/admin/plugins/portfolio-rtl/settings'
        }];
    ...
    HomePageSettings.getRoutes = function(cb) {
        var routes = [
            {
                method: 'get',
                path: '/admin/plugins/portfolio-rtl/settings/home_page',
                auth_required: true,
