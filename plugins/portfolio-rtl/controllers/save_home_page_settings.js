...
module.exports = function SaveHomePageSettingsModule(pb) {
    ...
    /**
     *  Saves settings for the display of home page content in the Portfolio(RTL) theme
    ...
    SaveHomePageSettings.prototype.render = function(cb) {
        ...
        this.getJSONPostParams(function(err, post) {
            ...
            var dao = new pb.DAO();
            dao.q('portfolio_rtl_theme_settings', opts, function(err, homePageSettings) {
                if (util.isError(err)) {
                ...
                if(homePageSettings.length > 0) {
                    ...
                    homePageSettings = pb.DocumentCreator.create('portfolio_rtl_theme_settings', post);
    ...
    SaveHomePageSettings.getRoutes = function(cb) {
        var routes = [
            {
                method: 'post',
                path: '/actions/admin/plugins/settings/portfolio-rtl/home_page',
                auth_required: true,
