...
module.exports = function (pb) {
    ...
    * Edits an article
    */
   function SS_EditArticle() {
      var ChannelService = require('./../../../../services/ChannelService.js')(pb);

      this.channelService = new ChannelService();
   }
   util.inherits(SS_EditArticle, pb.BaseController);

   SS_EditArticle.prototype.render = function (cb) {
      var self = this;
   ...
   SS_EditArticle.prototype.getRequiredFields = function () {
      return ['url', 'headline', 'article_layout', 'id'];
   };


   SS_EditArticle.prototype.getSanitizationRules = function () {
      return {
         article_layout: pb.BaseController.getContentSanitizationRules()
      };
   };

   SS_EditArticle.getRoutes = function (cb) {
      var routes = [
         {
            method: 'post',
         ...
         {
            method: 'post',
            path: "/actions/admin/content/content/:id",
            access_level: pb.SecurityService.ACCESS_WRITER,
            auth_required: true,
            content_type: 'text/html'
         }];
