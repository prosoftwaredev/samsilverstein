...
module.exports = function ChannelsControllerModule(pb) {
...
//pb dependencies
  ...
  util.inherits(ChannelsController, ss_baseController);
  
  ChannelsController.prototype.render = function (cb) {
    var self = this;
  ...
  ChannelsController.prototype.getTemplate = function (content, cb) {
  ...
  ChannelsController.prototype.getDefaultTemplatePath = function () {
    return 'index';
  };

  ChannelsController.prototype.gatherData = function (opt, cb) {
    var self = this;
  ...
  ChannelsController.prototype.isAccessToArticle = function (article) {
    var curentUser = this.session.authentication.user;
  };

  ChannelsController.prototype.loadContent = function (options, contentCallback) {
  ...
  ChannelsController.prototype.renderContent = function (content, contentSettings, themeSettings, index,
                                             cb) {
    var self = this;
  ...
  ChannelsController.prototype.renderArticle = function (content, contentSettings, themeSettings, index,
                                             cb) {
    var self = this;
    ...
    ats.registerLocal('article_sections', content.article_sections);
  ...
  ChannelsController.prototype.renderQuestion = function (content, contentSettings, themeSettings, index,
                                              cb) {
    var self = this;
    var isPage = content.object_type === 'page';
    var showByLine = contentSettings.display_bylines && !isPage;
  ...
  ChannelsController.prototype.renderPoll = function (content, contentSettings, themeSettings, index,
                                          cb) {
    var self = this;
    var isPage = content.object_type === 'page';
    var showByLine = contentSettings.display_bylines && !isPage;
  ...
  ChannelsController.prototype.renderComment = function (comment, cb) {
  ...
  ChannelsController.prototype.getContentSpecificPageName = function (content, cb) {
    if (!content) {
  ...
  ChannelsController.prototype.getNavigation = function (cb) {
    var options = {
  ...
  ChannelsController.getRoutes = function (cb) {
    var routes = [
      {
        method: 'get',
