...
module.exports = function (pb) {
   ...
   util.inherits(ContentForm, pb.BaseController);

   ContentForm.prototype.render = function (cb) {
      var self = this;
   ...
   ContentForm.prototype.finishRender = function (results, cb) {
      var self = this;
   ...
   ContentForm.prototype.onTemplateRetrieved = function (template, cb) {
      cb(null, template);
   };

   ContentForm.prototype.getAngularObjects = function (tabs, data) {
      var self = this;
...
//         data.article.article_topics = topics;
      ...
      var objects = {
         navigation: pb.AdminNavigation.get(this.session, ['content', 'contents'], this.ls),
...
//         topics: data.topics,
         ...
         post_url: '/admin/content/content',
         actions_url: '/actions/admin/content/content'
   };
   ...
   ContentForm.getSubNavItems = function (key, ls, data) {
      return [{
   ...
   ContentForm.prototype.getActivePill = function () {
      return 'new_article';
   };

   ContentForm.prototype.gatherData = function (vars, cb) {
      var self = this;
      var dao = new pb.DAO();
      var tasks = {
...
//         },
   ...
   ContentForm.prototype.getTabs = function () {
      var router = [
         {
            active: 'active',
            href: '#content',
...
//         }
   ...
   ContentForm.getRoutes = function (cb) {
      var routes = [
         {
            method: 'get',
            path: "/admin/content/content/new",
            access_level: pb.SecurityService.ACCESS_WRITER,
            auth_required: true,
            content_type: 'text/html'
         }, {
            method: 'get',
            path: "/admin/content/content/:id",
            access_level: pb.SecurityService.ACCESS_WRITER,
            auth_required: true,
            content_type: 'text/html'
         }];
...
//   pb.AdminSubnavService.registerFor('new_article', ContentForm.getSubNavItems);
