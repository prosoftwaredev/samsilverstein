...
module.exports = function (pb) {
  ...
  function SS_ManageArticles() {
    var ChannelService = require('./../../../services/ChannelService.js')(pb);

    this.channelService = new ChannelService();
  }

  util.inherits(SS_ManageArticles, ss_baseController);
  //statics
  var SUB_NAV_KEY = 'ss_manage_articles';
  var SECTION_KEY = 'challenges';
  ...
  SS_ManageArticles.prototype.render = function (cb) {
    var self = this;
    var dao = new pb.DAO();
//      var where = {};
...
//         where = self.permissionQueryArticle(where);
      ...
      dao.q('article', opts, function (err, articles) {
        ...
        pb.users.getAuthors(articles, function (err, articlesWithAuthorNames) {
          ...
          self.ts.registerLocal('article_url', '/admin/content/articles');
  ...
  SS_ManageArticles.prototype.gatherData = function (vars, cb) {
    var self = this;
    async.series({
  ...
  SS_ManageArticles.prototype.getArticleStatuses = function (articles) {
    var now = new Date();
  ...
  SS_ManageArticles.getSubNavItems = function (key, ls, data) {
    return [{
  ...
  SS_ManageArticles.getRoutes = function (cb) {
    var routes = [
      {
        method: 'get',
  ...
  pb.AdminSubnavService.registerFor(SUB_NAV_KEY, SS_ManageArticles.getSubNavItems);
  //exports
  return SS_ManageArticles;
};
