...
module.exports = function (pb) {
   ...
   util.inherits(OrganizationFormController, pb.BaseController);

   var SUB_NAV_KEY = 'organization_form';

   OrganizationFormController.prototype.render = function (cb) {
      var self = this;
      ...
      this.gatherData(vars, function (err, data) {
         ...
         self.ts.load('admin/content/organizations/organization_form', function (err, result) {
            cb({
               content: result
            });
         });
   ...
   OrganizationFormController.prototype.gatherData = function (vars, cb) {
      var self = this;
      ...
      var tasks = {
         ...
         navigation: function (callback) {
            callback(null, pb.AdminNavigation.get(self.session, ['content', 'organizations'], self.ls));
         },
   ...
   OrganizationFormController.prototype.loadFieldOptions = function (service, objectType, cb) {
      var self = this;
   ...
   OrganizationFormController.getSubNavItems = function (key, ls, data) {
      return [
         {
            name: 'manage_objects',
         ...
         },
         {
            ...
            title: '',
            icon: 'plus',
            href: '/admin/content/organizations/' + data.objectType[pb.DAO.getIdField()] + '/new'
         }
      ];
   };

   OrganizationFormController.getRoutes = function (cb) {
      var routes = [
         {
            path: "/admin/content/organizations/:type_id/new",
         ...
         , {
            path: "/admin/content/organizations/:type_id/:id",
            access_level: pb.SecurityService.ACCESS_ADMINISTRATOR,
            auth_required: true,
            handler: 'render',
            content_type: 'text/html'
   ...
   pb.AdminSubnavService.registerFor(SUB_NAV_KEY, OrganizationFormController.getSubNavItems);

   //exports
   return OrganizationFormController;
};
