...
module.exports = function (pb) {
   ...
   * @constructor
   */
  function SS_MediaForm() {}
  util.inherits(SS_MediaForm, pb.BaseController);

  //statics
  var SUB_NAV_KEY = 'ss_media_form';

  /**
   * @method render
   * @param {Function} cb
   */
  SS_MediaForm.prototype.render = function (cb) {
	var self = this;
  ...
  SS_MediaForm.prototype.gatherData = function (vars, cb) {
	var self = this;
	var dao = new pb.DAO();
  ...
  SS_MediaForm.prototype.getMediaTopics = function (data) {
	var topics = [];
  ...
  SS_MediaForm.getSubNavItems = function (key, ls, data) {
	return [{
		name: 'manage_media',
  ...
  SS_MediaForm.getRoutes = function (cb) {
	var routes = [
	  {
		method: 'get',
  ...
  pb.AdminSubnavService.registerFor(SUB_NAV_KEY, SS_MediaForm.getSubNavItems);
