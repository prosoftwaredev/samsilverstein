//dependencies
// This is modified clone of baseDir/include/admin navigation.js
...
//            },
            {
               id: 'articles',
               title: 'Challenges', // old name Articles
               icon: 'files-o',
            ...
            {
               id: 'contents',
               title: 'Content', // dublicate Articles(challenges)
               icon: 'files-o',
            ...
            {
               id: 'questions',
               title: 'Topics', //old name questions
               icon: 'file-o',
   ...
   AdminNavigation.removeUnauthorized = function (session, adminNavigation, activeItems) {
      for (var i = 0; i < adminNavigation.length; i++) {
         if (typeof adminNavigation[i].access !== 'undefined') {
            ...
            if (!pb.security.isAuthorized(session, {
               admin_level: adminNavigation[i].access
            })) {
            ...
            if (adminNavigation[i].children.length > 0) {
               ...
               for (var j = 0; j < adminNavigation[i].children.length; j++) {
                  ...
                  if (typeof adminNavigation[i].children[j].access !== 'undefined') {
                     ...
                     if (!pb.security.isAuthorized(session, {
                        admin_level: adminNavigation[i].children[j].access
                     })) {
   ...
   AdminNavigation.getRoutes = function (cb) {
      var routes = [];
      cb(null, routes);
   };
   //exports
